<?php
	...
	if ($Account_C == 'student') {
		...
		$City=mysqli_real_escape_string($connectivity,$_POST['city']);
		$Province=mysqli_real_escape_string($connectivity,$_POST['province']);
		...
		$row_count= mysqli_num_rows($result);
			...
			elseif ($Pass != $C_Pass) {
				...
				$Database="INSERT INTO student(name,email,password,date_of_birth,Gender,photo,address,course_type,province,city)VALUES('$Name','$Email','$Pass','$Dob','$Sex','$Photo','$Address','$Course','$Province','$City')";
